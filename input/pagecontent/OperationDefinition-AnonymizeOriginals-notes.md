...
* [Request-Body](Parameters-Parameters-AnonymizeOriginals-request-example-1.html)
* [Rückmeldung](Parameters-Parameters-AnonymizeOriginals-response-example-1.html)
